...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210414_tinchap_f5a48cd9b881ae3a4018_20210726130315_archive.zip';
	const ARCHIVE_SIZE		 = '49262570';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f5a48cd-26130315';
    const SECONDARY_PACKAGE_HASH = '340d73a-26130315';
	const VERSION			 = '1.4.0';
