...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210414_tinchap_e8c0ee0a60c37bf62545_20210429044733_archive.zip';
	const ARCHIVE_SIZE		 = '40451900';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'e8c0ee0-29044733';
    const SECONDARY_PACKAGE_HASH = 'df027d7-29044733';
	const VERSION			 = '1.4.0';
